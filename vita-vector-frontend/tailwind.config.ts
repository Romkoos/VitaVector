...
const config: Config = {
	...
	theme: {
		extend: {
			colors: COLORS,
			spacing: { 0.5: '0.12rem', layout: '1.4rem', 'big-layout': '2.3rem' },
			fontSize: {
				xs: '0.9rem',
				sm: '1.07rem',
				base: '1.18rem',
			...
			backgroundImage: {
				balanceDashboard: "url('/src//public/img/dashboards/balanceImg.png')",
				ellipsisModeCarInterface:
					"url('https://i.ibb.co/Y3nrFfd/ellipse-light.png')",
				ellipsisModeCarInterfaceDark:
